...
import com.example.playlistmaker.databinding.PlaylistItemInPlayerBinding
...
class PlaylistInPlayerViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    ...
    private val binding: PlaylistItemInPlayerBinding = PlaylistItemInPlayerBinding.bind(view)
